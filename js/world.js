...
World.prototype.makeRoomPlans = function (name) {
  ...
  if (name === "Area 51") {
    ...
    this.rooms[5][3] = new Level(builder, 5, 3, this.game);

    builder = [
      "XXXXXXXXXXXXXXOOOOXXXXXXX",
      "X            X    X     X",
      "X  *                    X",
      "X         D    N        X",
      "X                       X",
    ...
    this.rooms[4][4] = new Level(builder, 4, 4, this.game);
    this.rooms[4][4].portalRoom = true;
